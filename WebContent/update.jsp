...
<div class="container">
<div class="row">
<form method="post" action="updateAction.jsp?bbjID=<%= bbjID %>">
...
<tbody>
<tr>
<td><input type="text" class="form-control" placeholder="글 제목" name="bbjTitle" maxlength="50" value="<%= bbj.getBbjTitle() %>"></td>
</tr>
<tr>
<td><textarea class="form-control" placeholder="글 내용" name="bbjContent" maxlength="2048" style="height:350px;"><%= bbj.getBbjContent() %></textarea></td>
</tr>
</tbody>
</table>
